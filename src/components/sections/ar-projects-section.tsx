...
// VR Headset Icon Component - Simplified
function VRHeadsetIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path
        d="M 40 90 Q 30 70, 40 55 L 160 55 Q 170 70, 160 90"
        stroke="currentColor"
        strokeWidth="6"
        strokeLinecap="round"
        fill="none"
      ...
      {/* Main headset body - more rounded */}
      <rect
        x="30"
        y="75"
        width="140"
